import{j2 as f,j3 as m,j4 as P,et as g,j5 as y,r as _,j6 as $,j7 as u,j8 as O,j9 as A,ja as S,jb as x,c5 as o,jc as v,jd as C,je as p,jf as E,jg as T,e as n,jh as l,ji as d,jj as w,_ as F,jk as b,jl as D,jm as N,jn as M,jo as R,jp as I,jq as L,jr as U,js as B,jt as W,ju as z,jv as G,jw as H,jx as q,jy as Q,jz as V,jA as k,c6 as c,jB as J,jC as K,jD as X,jE as Y}from"./index.857de027.js";function Z(a){const e=new f,{vertex:t,fragment:s}=e;return m(t,a),e.include(P,a),e.attributes.add(g.POSITION,"vec3"),e.attributes.add(g.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.uniforms.add(new y("textureCoordinateScaleFactor",r=>_(r.texture)&&_(r.texture.descriptor.textureCoordinateScaleFactor)?r.texture.descriptor.textureCoordinateScaleFactor:$)),t.code.add(u`
    void main(void) {
      vpos = position;
